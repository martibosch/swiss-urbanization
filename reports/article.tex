...
\begin{figure}[!ht]
    \centering  
    \includegraphics[width=\linewidth]{figures/population_change}
    \vspace{.5em}
    \caption[Population change]{\label{figures/population_change}Population change of the three regions of study at the city core (left) and agglomeration extent (right) over the periods of 1990-2000, 2000-2010 and 2010-2017. Data from the Urban Audit collection \mycitep{sfso2018city}.}
\end{figure}
...
\begin{figure}[!ht]
  \begin{adjustwidth}{0cm}{-.4\textwidth}
    \centering  
    \includegraphics[width=\linewidth]{figures/landscape_plots}
    % \vspace{.5em}
...
\begin{figure}[!ht]
  \begin{adjustwidth}{0cm}{-.4\textwidth}
    \centering
    \includegraphics[width=\linewidth]{figures/area_radius_scaling}
    \vspace{.5em}
...
\begin{figure}[!ht]
  \begin{adjustwidth}{0cm}{-.3\textwidth}
    \centering
    \includegraphics[width=1.3\textwidth]{figures/metrics_time_series}
...
\begin{figure}[!ht]
  \begin{adjustwidth}{0cm}{-.4\textwidth}
    ...
    \includegraphics[width=1.3\textwidth]{figures/growth_modes}
